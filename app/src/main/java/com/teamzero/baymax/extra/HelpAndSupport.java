...
public class HelpAndSupport extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_help_and_support, container, false);
            ImageView[] imageView=new ImageView[3] ;
            imageView[0]= rootView.findViewById(R.id.helpimage);
            imageView[1]= rootView.findViewById(R.id.helpimage2);
            imageView[2]= rootView.findViewById(R.id.helpimage3);
            imageView[0].setVisibility(View.INVISIBLE);
            imageView[1].setVisibility(View.INVISIBLE);
            imageView[2].setVisibility(View.INVISIBLE);
            imageView[getArguments().getInt(ARG_SECTION_NUMBER)].setVisibility(View.VISIBLE);
            return rootView;
        }
    }
